...
public class ContactsConstant {
    ...
    public static final String EMAIL_REGULAR_EXPRESSION_FOR_VALIDATION = "^(?=.{1,64}@)[A-Za-z0-9_-]+(\\.[A-Za-z0-9_-]+)*@[^-][A-Za-z0-9-]+(\\.[A-Za-z0-9-]+)*(\\.[A-Za-z]{2,})$";

    public static final String PHONE_REGULAR_EXPRESSION_FOR_VALIDATION = "\\+\\d{1,3}\\d{10}";
}
